    ...
    <div className="container m-auto">
      <div className="grid md:grid-cols-2 gap-1 grid-cols-1 p-8">
        <div className="mb-4 pr-6 border-r-2 border-[#61D9DE]">
          <div className="mb-4">
            <p className="text-blue text-2x1 font-medium">Adicionar Eventos</p>
          ...
          <Input 
            title="Endereço"
            placeholder="Insira o nome do seu Endereço"
            type="text"
          />
          <Input 
            title="Cupom"
          ...
          <p className="text-blue text-base font-medium mb-4">Crie o seu próprio evento da maneira que você preferir! :)</p>
          ...
          <div className="mb-4" >
            ...
            <p className="text-neutural-500 text-sm font-light">
              Caso seu evento seja gratuito, o campo deverá ficar vazio. Caso haja mais de um setor, basta adicionar seção. Se houver cupom promocional, basta colocar o código no campo “cupom”.
            </p>  
          </div>
